<?php 
$nroDia = date( 'N' ); // obtengo el dia de la semana en nro(Lu=1,...,Do=7)
$proximo_lunes = time() + ( (7-($nroDia - 5)) * 24 * 60 * 60 );
$lunes =  date('Y-m-d', $proximo_lunes);
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="active" href="index.php" ><i class="fa fa-tachometer"></i>Dashboard </a>
                        </li>
        ...
        <div class="page-wrapper">
                                ...
                                <div class="testimonial-widget-one owl-carousel owl-theme">
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            ...
                                            <div class="testimonial-author">Próximo Cierre</div>
                                            <div class="testimonial-author-position"><?php echo $lunes;?> </div>
                                    ...
                                    <div class="item">
                                        <div class="testimonial-content">
                                            ...
                                            <div class="testimonial-author"><?php echo $nroDia;?></div>
            ...
            <!-- End Container fluid  -->
            <!-- footer -->
            <footer class="footer"> © 2018 All rights reserved. Pagado by <a href="https://www.gtdesarrollo.com">GT Desarrollo</a></footer>
            <!-- End footer -->
        </div>
        <!-- End Page wrapper  -->
    </div>
